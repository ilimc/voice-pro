...
from app.abus_asr_diarize import *
...
class GradioASR:
    ...
    def switch_case(self, case):
        switch_dict = {
            ...
            'transcribe-diarize': lambda: DiarizeInference()
        }
    ...
    def get_asr_engines(self):
        return ['faster-whisper', 'whisper', 'whisper-timestamped', 'whisperX', 'transcribe-diarize']        
